...
export default function ParkopediaCarTrackingPage() {
          ...
          <div className="mb-8 bg-gray-50 rounded-lg border border-gray-200 p-6">
            ...
            <div className="flex gap-4">
              <button
                ...
                className="px-4 py-2 text-white rounded hover:opacity-90 font-medium transition"
                                  ...
                                  <tr key={car.id} className={`border-b text-xs ${getRowColor(status.status)}`}>
                                    ...
                                    <td className="px-1 py-1 text-center">
                                      <button
                                        ...
                                        className="text-xs px-1 py-0 text-white rounded hover:opacity-90 transition whitespace-nowrap"
                                        style={{ backgroundColor: PARKOPEDIA_BRAND }}
                                      >
                                        Exit
                                      </button>
