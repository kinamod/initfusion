...
const PARKOPEDIA_BRAND = '#0A0944';
const PARKOPEDIA_CONTRAST = '#02FF7F';

export default function ParkopediaZonePage() {
    ...
    const handleMapClick = (e: any) => {
      ...
      if (newPolygon.length > 1) {
        ...
        L.polyline(
          ...
          { color: PARKOPEDIA_CONTRAST, weight: 2 }
        ).addTo(drawnItemsRef.current);
      }
      ...
      if (newPolygon.length >= 3) {
        L.polyline(
          ...
          { color: PARKOPEDIA_CONTRAST, weight: 2, dashArray: '5, 5' }
        ).addTo(drawnItemsRef.current);
      }
    };
  ...
  return (
    <div className="flex flex-col h-screen w-full">
      <Header 
        logoSrc="https://www.parkopedia.com/public/images/header-logo-new@2x.png"
        logoAlt="Parkopedia"
        title=""
        brandColor={PARKOPEDIA_BRAND}
        contrastColor={PARKOPEDIA_CONTRAST}
      />
      <div className="flex flex-1">
        <div className="flex-1 relative">
            ...
            <div className="absolute top-4 right-4 bg-white shadow-lg rounded-lg p-4" style={{ zIndex: 9999 }}>
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="px-4 py-2 text-white rounded hover:opacity-90 text-sm font-medium transition"
                  style={{ backgroundColor: PARKOPEDIA_CONTRAST, color: PARKOPEDIA_BRAND }}
                >
                  Complete
                </button>
                <button
          ...
          {!isDrawing && (
            <button
              ...
              className="absolute top-4 right-4 px-4 py-2 text-white rounded hover:opacity-90 font-medium transition"
              style={{ backgroundColor: PARKOPEDIA_BRAND, zIndex: 9999 }}
            >
              Draw Zone
            </button>
          )}
        ...
        <div className="w-80 bg-white shadow-lg overflow-hidden flex flex-col">
          <div 
            ...
            style={{ background: `linear-gradient(to right, ${PARKOPEDIA_BRAND}, #1a0d5e)` }}
          >
                ...
                <tbody>
                  {zones.map((zone) => (
                    <tr
                      ...
                      style={{
                        backgroundColor: selectedZoneId === zone.id ? `${PARKOPEDIA_BRAND}15` : 'transparent',
              ...
              <div className="border-t bg-gray-50 p-4">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <button
                    ...
                    className="text-xs px-2 py-1 text-white rounded hover:opacity-90 transition"
                    style={{ backgroundColor: PARKOPEDIA_BRAND }}
                  >
                    Edit
                  </button>
                </div>
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4 p-6">
            ...
            <div className="flex gap-2 mt-6">
              ...
              <button
                ...
                className="flex-1 px-4 py-2 text-white rounded hover:opacity-90 font-medium transition"
                style={{ backgroundColor: PARKOPEDIA_BRAND }}
              >
                Save
              </button>
