...
const RINGGO_BRAND = '#882877';
const RINGGO_ACCENT = '#FE52A2';

export default function RingGoZonePage() {
    ...
    const handleMapClick = (e: any) => {
      ...
      if (newPolygon.length >= 3) {
        L.polyline(
          ...
          { color: RINGGO_ACCENT, weight: 2, dashArray: '5, 5' }
        ).addTo(drawnItemsRef.current);
      }
    };
  ...
  return (
    <div className="flex flex-col h-screen w-full">
      <Header 
        logoSrc="https://myringgo.co.uk/images/easypark/Ringgo_Arrive.png"
        logoAlt="RingGo"
        title=""
        brandColor={RINGGO_BRAND}
        contrastColor={RINGGO_ACCENT}
      />
      <div className="flex flex-1">
        <div className="flex-1 relative">
            ...
            <div className="absolute top-4 right-4 bg-white shadow-lg rounded-lg p-4" style={{ zIndex: 9999 }}>
              ...
              <div className="flex gap-2">
                <button
                  ...
                  style={{ backgroundColor: RINGGO_ACCENT, color: RINGGO_BRAND }}
                >
                  Complete
                </button>
                <button
          ...
          {!isDrawing && (
            <button
              ...
              style={{ backgroundColor: RINGGO_BRAND, zIndex: 9999 }}
            >
              Draw Zone
            </button>
          )}
        ...
        <div className="w-80 bg-white shadow-lg overflow-hidden flex flex-col">
          <div 
            ...
            style={{ background: `linear-gradient(to right, ${RINGGO_BRAND}, #6b1d52)` }}
          >
                ...
                <tbody>
                  {zones.map((zone) => (
                    <tr
                      ...
                      style={{
                        backgroundColor: selectedZoneId === zone.id ? `${RINGGO_BRAND}15` : 'transparent',
              ...
              <div className="border-t bg-gray-50 p-4">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <button
                    ...
                    style={{ backgroundColor: RINGGO_BRAND }}
                  >
                    Edit
                  </button>
                </div>
